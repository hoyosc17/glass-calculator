...
document.getElementById("espesorVidrio").addEventListener("input", () => {
...
document.getElementById("anchoVidrio").addEventListener("input", () => {
...
document.getElementById("alturaVidrio").addEventListener("input", () => {
